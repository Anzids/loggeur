...
public class Fatal implements Logg {

	private Date date;
	private DateFormat dateFormat;
	private static Fatal instance = null;
	private File logFile;

	/**
	 * Initialisation des dates de Fatal
	 */
	private Fatal() {
		this.date = new Date();
	...
	public String afficherError(Object message, int niveau, String chemin, String Consl, String File)
		...
		String messageFinal = "";
		if (niveau <= 5) {
			messageFinal = "[" + this.dateFormat.format(this.date) + "]" + " (class Fatal) : <" + message + ">\n";
	...
	public void afficherError(String message, int niveau, String[] Data) throws IOException {
		// TODO Auto-generated method stub
		if (niveau <= 5) {
			String messageFinal = "[" + this.dateFormat.format(this.date) + "]" + " (class Fatal) : <" + message
					+ ">\n";
